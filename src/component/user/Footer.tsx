...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#FDF8F1] text-gray-700 relative overflow-hidden font-sans border-t border-[#9c7c5d]/20">

      {/* Decorative Background Element */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#9c7c5d]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-[#ED695A]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6 text-left animate-fade-in-up">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3 text-sm text-[#5B4336] group cursor-pointer hover:text-[#9c7c5d] transition-colors">
                <div className="p-2 bg-white rounded-full shadow-sm border border-[#9c7c5d]/15 group-hover:bg-[#9c7c5d]/10 transition-colors">
          ...
          <div className="text-left animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <h4 className="text-lg font-serif font-bold text-[#5B4336] mb-6 relative inline-block">
              Explore
          ...
          <div className="text-left space-y-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <h4 className="text-lg font-serif font-bold text-[#5B4336] mb-2">Partner With Us</h4>
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full border border-[#9c7c5d] text-[#9c7c5d] bg-white hover:bg-[#9c7c5d] hover:text-white px-4 py-3 rounded-lg text-sm font-semibold transition-all flex items-center justify-between group"
              >
            ...
            <div className="pt-4">
                <div className="flex gap-3">
                  {[Facebook, Instagram, Twitter, Linkedin, Youtube].map((Icon, i) => (
                      <div key={i} className="p-2 bg-white rounded-full shadow-sm border border-[#9c7c5d]/15 hover:bg-[#9c7c5d] text-[#9c7c5d] hover:text-white transition-all cursor-pointer transform hover:-translate-y-1">
                        <Icon size={18} />
                      </div>
                    )
                  )}
      ...
      {/* BOTTOM COPYRIGHT */}
      <div className="border-t border-[#9c7c5d]/20 bg-[#f7efe5]">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <p>
            © {year} <span className="text-[#5B4336] font-semibold">iBookingVenue</span>. All rights reserved.
          </p>
          <div className="flex gap-6">
             <span className="hover:text-[#9c7c5d] cursor-pointer">Sitemap</span>
             <span className="hover:text-[#9c7c5d] cursor-pointer">Security</span>
             <p>Designed with <span className="text-[#ED695A]">♥</span> by Team</p>
          </div>
        </div>
      </div>
    </footer>
