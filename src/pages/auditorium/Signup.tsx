        ...
        <div className="md:w-3/5 p-4 md:p-6 flex justify-center items-start bg-white  h-full">
          <div className="w-full max-w-3xl py-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Location Section */}
              {/* <div className="bg-gray-50 p-4 rounded-lg mb-4">
                <h3 className="text-[#78533F] font-semibold mb-3 border-b border-[#b09d94] pb-2">Location Details</h3>
              ...
              {/* <div className="bg-gray-50 p-4 rounded-lg mb-4">
                <h3 className="text-[#78533F] font-semibold mb-3 border-b border-[#b09d94] pb-2">Auditorium Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
              ...
              {/* Facilities Section */}
              {/* <div className="bg-gray-50 p-4 rounded-lg mb-4">
                <h3 className="text-[#78533F] font-semibold mb-3 border-b border-[#b09d94] pb-2">Facilities Offered</h3>
