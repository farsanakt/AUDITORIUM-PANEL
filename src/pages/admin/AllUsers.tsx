...
import { Search, Trash, Edit, Lock, Unlock, ChevronRight, ChevronDown, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#FDF8F1] flex flex-col">
      ...
      <main className="flex-1 p-4 lg:p-8">
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm mb-8 border border-[#b09d94]">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
              <h2 className="text-2xl lg:text-3xl font-bold text-[#78533F] font-serif">Users ({filteredUsers.length})</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-[#b09d94]">
            {currentUsers.length === 0 ? (
              ...
              currentUsers.map((user) => (
                <div key={user._id} className="p-4 hover:bg-[#FDF8F1] transition-colors border-b border-[#b09d94]/30 last:border-b-0">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center space-x-3 flex-shrink-0">
                      ...
                      <button
                        ...
                        className={`p-3 rounded-lg ${user.isBlocked ? 'hover:bg-green-50 text-green-600' : 'hover:bg-red-50 text-red-600'}`}
                      >
